...
export const AboutSection: React.FC = () => {
  return (
    <section id="about-section" className="bg-white py-10 w-full scroll-mt-20">
          ...
          <div className="lg:col-span-6">
            <ScrollReveal animation="fade-left" duration={800}>
              <div className="flex items-center justify-center relative py-6 select-none">
                ...
                <div className="relative w-[280px] h-[280px] sm:w-[380px] sm:h-[380px] rounded-full border-2 border-red-500 overflow-hidden bg-slate-100 shadow-lg z-20 hover-3d cursor-pointer">
                  <img
            ...
            <ScrollReveal animation="fade-right" duration={800} delay={150}>
              <div className="flex flex-col justify-start text-left">
                ...
                <p className="text-gray-500 text-sm sm:text-base leading-relaxed font-light mb-6">
                  Varahi Communications is dedicated to helping individuals and businesses achieve their financial aspirations. We simplify the borrowing experience with transparent processes, competitive interest rates, and tailored lending structures that fit your lifestyle and cash flow needs.
                </p>
                ...
                <div>
                  <button className="bg-red-500 hover:bg-red-600 text-white font-bold transition-all duration-300 shadow-md hover:shadow-lg rounded-md px-8 py-3 text-[15px] uppercase tracking-wider cursor-pointer active:scale-95 duration-200 btn-3d">
                    View more
                  </button>
                </div>
              </div>
