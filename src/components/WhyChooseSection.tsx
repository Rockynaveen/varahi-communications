          ...
          <div className="lg:col-span-6 opacity-0 animate-fade-in-left order-2 lg:order-1">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-start">
              <div className="flex flex-col gap-6 sm:pt-12">
                {/* Guarantee Card */}
                <div className="relative bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100/50 transform transition-all duration-500 hover:-translate-y-3 group cursor-pointer overflow-hidden z-10">
                  ...
                  <div className="relative w-20 h-20 mx-auto rounded-full bg-white border border-red-100 shadow-sm flex items-center justify-center text-[#ee3124] mb-6 z-10 transition-all duration-500 group-hover:bg-[#ee3124] group-hover:text-white group-hover:rotate-[360deg] group-hover:scale-110">
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                    </svg>
                  </div>
                  
                  <h3 className="text-gray-900 text-xl font-bold mb-3 text-center z-10 relative group-hover:text-[#ee3124] transition-colors duration-300">
                    Guarantee
                  </h3>
                ...
                <div className="relative bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100/50 transform transition-all duration-500 hover:-translate-y-3 group cursor-pointer overflow-hidden z-10">
                  ...
                  <h3 className="text-gray-955 text-xl font-bold mb-3 text-center z-10 relative group-hover:text-[#ee3124] transition-colors duration-300">
                    Reliability
                  </h3>
